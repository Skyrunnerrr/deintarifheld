...
export function hasRecaptchaEnterpriseSiteKey() {
  // Enterprise loader/API only when an explicit Enterprise site key is configured.
  // Standard SITE_KEY / PUBLIC_KEY must not trigger enterprise.js (breaks checkbox render).
