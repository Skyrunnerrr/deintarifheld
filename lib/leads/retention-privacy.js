...
export const ANONYMISED_EMAIL = 'redacted@invalid.invalid'
...
/**
 * Remove identity/contact/message PII from a stored payload.
 * `firma` is kept only when keepFirma is true (business ops correlation).
 */
export function anonymisePayload(payload, { keepFirma = false } = {}) {
