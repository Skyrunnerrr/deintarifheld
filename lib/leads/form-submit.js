...
const COPY = {
  informal: {
    ...
    mail: 'Deine Angaben sind gespeichert, die Benachrichtigung konnte gerade nicht zugestellt werden. Bitte versuche es gleich noch einmal.',
  ...
  formal: {
    ...
    mail: 'Ihre Angaben sind gespeichert, die Benachrichtigung konnte gerade nicht zugestellt werden. Bitte versuchen Sie es gleich noch einmal.',
