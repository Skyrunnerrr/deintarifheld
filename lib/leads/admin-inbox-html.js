...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    input[type=password] { width: 100%; padding: 10px 12px; border: 1px solid #c5ccd6; border-radius: 8px; margin: 0 0 12px; }
...
<body>
  <div class="wrap">
    ...
    <div id="toolbar" class="bar">
      ...
      <form method="post" action="/api/admin/inbox/" style="margin:0">
