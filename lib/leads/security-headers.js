...
/** Tight CSP for the ops inbox HTML (inline script/style only, same-origin data fetch). */
export const INBOX_SECURITY_HEADERS = {
  ...
  'Content-Security-Policy':
    "default-src 'none'; script-src 'unsafe-inline'; style-src 'unsafe-inline'; img-src 'none'; connect-src 'self'; form-action 'self'; frame-ancestors 'none'; base-uri 'none'; object-src 'none'",
}
