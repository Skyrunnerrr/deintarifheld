...
| PRIVATE_SCHEMAS / DEFAULT_PRIVILEGE_HARDENING | AUTHORED_PRE_APPLY_FREEZE (M11E-R1A; apply=R1B) |
...
| Control | Status |
|---|---|
| ACTIVE_GOVERNED_MIGRATIONS | 001,002 + 20260813104040 (R1A freeze; Staging remote still 001,002) |
| LEGACY_003_013 | ARCHIVED_REFERENCE_ONLY |
| NORMAL_DB_PUSH_QUEUE_CLEAN | PASS pre-R1A; R1A dry-run pending=1 (exact M11E) |
| NEW_GOVERNED_MIGRATION_VERSIONING | TIMESTAMP_BASED |
| VERSION_REUSE_003_013 | FORBIDDEN |
| ACL_01 / PRIVATE_SCHEMAS | MIGRATION_FROZEN_SHA256 (R1A); APPLY_PENDING_R1B |
