...
| PRIVATE_SCHEMAS / DEFAULT_PRIVILEGE_HARDENING | NOT_IMPLEMENTED (M11E) |
...
| Control | Status |
|---|---|
| ACTIVE_GOVERNED_MIGRATIONS | 001,002 ONLY |
| LEGACY_003_013 | ARCHIVED_REFERENCE_ONLY |
| NORMAL_DB_PUSH_QUEUE_CLEAN | PASS (Staging dry-run pending=0) |
| NEW_GOVERNED_MIGRATION_VERSIONING | TIMESTAMP_BASED |
| VERSION_REUSE_003_013 | FORBIDDEN |
| ACL_01 / PRIVATE_SCHEMAS | NOT_IMPLEMENTED (R1) |
