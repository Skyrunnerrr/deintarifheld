...
## M11E-R4 Hosted Data API Exposure Controls
...
| HOSTED_EXTRA_SEARCH_PATH | public,extensions |
| AUTOMATIC_EXPOSURE_SETTING | OFF |
| OPS/SECURITY/WORKFLOW/AUDIT_EXPOSED | NO |
| PRIVATE_SCHEMAS_IN_EXTRA_SEARCH_PATH | NO |
| PRIVATE_SCHEMA_DB_USAGE_DENIED | YES |
...
## M11E-F Freeze Controls

| Control | Status / Evidence |
|---|---|
| PRIVATE_SCHEMA_DB_BOUNDARY | PASS (R1B + F final readback) |
| PROVIDER_EXPOSURE_BOUNDARY | PASS (R4) |
| FUTURE_TABLE_DEFAULT_DENY | PASS (R2) |
| FUTURE_SEQUENCE_DEFAULT_DENY | PASS (R2) |
| FUTURE_ROUTINE_EXPLICIT_API_DEFAULT_DENY | PASS (R2/R3C) |
| FUTURE_ROUTINE_PUBLIC_EXECUTE_DENY | PASS (R3A/R3C) |
| MIGRATION_HASH_BINDING | PASS (04c8dd4b… / 871c2052…) |
| STAGING_ONLY_APPLY | PASS (R1B/R3C) |
| BEHAVIORAL_ROLLBACK_TESTS | PASS (R2/R3A/R3C) |
| ACL_01 | RESOLVED_WITH_FROZEN_SCOPE |
| ACL_02 | OPEN_M11G |
| M11E | PASS / FROZEN |
| M11F_ENTRY_GATE | OPEN |
| PRODUCTION_SECURITY_MUTATION | NO |
