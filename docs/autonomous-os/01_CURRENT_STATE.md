...
GLOBAL_ROUTINE_DEFAULT_CONTROL_EFFECTIVE=YES (transactional proof only; NOT persisted)
PUBLIC_ROUTINE_FAIL_CLOSED_GAP=CONFIRMED_PENDING_R3B_APPLY
ACL_01_CORE_API_ROLE_DEFAULTS_RESOLVED=YES
ACL_01_FULL_FAIL_CLOSED=NO
ACL_01_RESOLVED=NO
ACL_02_RESOLVED=NO
NEXT=DTH-M11E-R3B_ROUTINE_DEFAULT_SECURITY_MIGRATION_PREAPPLY
PRODUCTION_SECURITY_MUTATION_ALLOWED=NO
```
