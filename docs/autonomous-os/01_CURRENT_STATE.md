...
GLOBAL_ROUTINE_DEFAULT_PERSISTED=NO
PUBLIC_ROUTINE_FAIL_CLOSED_GAP=CONFIRMED_PENDING_R3C_APPLY
ACL_01_FULL_FAIL_CLOSED=NO
ACL_01_RESOLVED=NO
ACL_02_RESOLVED=NO
NEXT=DTH-M11E-R3C_STAGING_ROUTINE_DEFAULT_APPLY_AND_REPROOF
PRODUCTION_SECURITY_MUTATION_ALLOWED=NO
```
