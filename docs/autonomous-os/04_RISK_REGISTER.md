...
## M11E-R3B RISK POSITION

FROZEN_PENDING_R3C:
- Migration authored/hashed for OPTION_A global revoke; not applied

CANONICAL_OPEN_UNTIL_R3C_REPROOF:
- DTH-RISK-FUNCTION-PUBLIC-EXECUTE
...
## M11E-R4 RISK POSITION

CLOSED_IN_STAGING_PROVIDER_CONFIG:
