...
| A11-S02 | A11 | Strong AuthZ/roles | E2 matrix + M11J enforced | E2 | Security | OD-A11-ROLE-CAPABILITY | | YES M11K | | M11K | YES | | | | | SECURITY | SECURITY_REQUIRED |
...
| M11-F-P | M11 | AuthZ/runtime/session/pooler | **M11F–J E2 proven**; K–P open | E2/E0 | Staging | | | YES | | M11K next | YES | | | | | SECURITY | PARTIAL |
...
- Provider gates: ≥12
- Security: M11F+M11G+M11H+M11I+M11J PROVEN_E2_LOCAL; M11K–P NOT_STARTED; M11E PARTIAL (staging exposure only)
...
Next gate: `M11K` request-scoped DB context (after M11J server AuthZ close).
