...
|----|--------|----------|----------|
| OD-A11-AUTH-PROVIDER | A11 | Production IdP + MFA + person mapping | `OWNER_COMMAND_CENTER_AUTH_PROVIDER_REQUIRED=YES`; TEST_* only |
| OD-A11-OPERATOR-SESSION | A11 | Session duration / MFA policy | `OWNER_OPERATOR_SESSION_POLICY_REQUIRED` |
...
| OD-A11-ROLE-CAPABILITY | A11 | Freeze role→capability (+ M11J mapping) |
...
`OWNER_DECISION_REQUIRED:OD-A11-AUTH-PROVIDER`
