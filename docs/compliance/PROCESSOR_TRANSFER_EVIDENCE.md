...
| Google reCAPTCHA | Bot protection on forms | YES — **reCAPTCHA v3 Enterprise Assessment** (code path). Account/DPA acceptance is **UNKNOWN** | Cloud DPA DOCUMENT_AVAILABLE https://cloud.google.com/terms/data-processing-addendum — that document is a **Google Cloud** customer DPA. Account acceptance of that Cloud DPA is **UNKNOWN** and must **not** be assumed | TRANSFER_EVIDENCE_AVAILABLE for Google Cloud customers; **not** claimed as accepted for this account | TIA_UNKNOWN | REGION_UNKNOWN (Google) | Official Assessment docs: https://cloud.google.com/recaptcha/docs/create-assessment . Verify URL used by code: `https://recaptchaenterprise.googleapis.com/v1/projects/{PROJECT_ID}/assessments`. Browser script: `https://www.google.com/recaptcha/enterprise.js`. |
