...
assert.match(captcha, /RECAPTCHA_PROJECT_ID/)
assert.match(captcha, /RECAPTCHA_API_KEY/)
...
assert.match(captchaAction, /enterprise_v3_assessment/)
...
assert.match(deleteRoute, /evaluateAdminEraseInput/)
