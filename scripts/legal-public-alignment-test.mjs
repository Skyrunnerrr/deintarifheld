...
requireMatch('datenschutz transactional confirmation', datenschutz, /automatische[\s\S]{0,80}Eingangsbestätigung/)
...
console.log('AGB_TRANSACTIONAL_MAIL_ALIGNMENT=PASS')
