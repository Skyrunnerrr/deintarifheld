...
dth_cd_load_config() {
  ...
  ALLOW_CUSTOMER_MAIL="${ALLOW_CUSTOMER_MAIL:-NO}"
}
...
EOF
      ...
      ;;
    live)
      if [[ "${ALLOW_CUSTOMER_MAIL:-NO}" == "YES" ]]; then
        cat <<'EOF'
CUSTOMER_TRAFFIC_MAIL_GATE=PASS
MAIL_MODE=live
...
TEMPORARY_MODE=NO
VERIFIED_CUSTOM_DOMAIN=REQUIRED
FOLLOW_UP_REQUIRED=NONE
MOCK_CUTOVER_BLOCKED=YES
FAIL_CUTOVER_BLOCKED=YES
INTERNAL_LIVE_NOTIFICATION_GATE=N/A
...
INTERNAL_NOTIFICATION=LIVE
CUSTOMER_CONFIRMATION=BLOCKED_BY_DUAL_GUARD
TEMPORARY_MODE=NO
VERIFIED_CUSTOM_DOMAIN=REQUIRED
FOLLOW_UP_REQUIRED=SET_ALLOW_CUSTOMER_MAIL_IF_CONFIRMATIONS_ARE_REQUIRED
MOCK_CUTOVER_BLOCKED=YES
FAIL_CUTOVER_BLOCKED=YES
INTERNAL_LIVE_NOTIFICATION_GATE=N/A
CUSTOMER_CONFIRMATION_REPORTED_OFF=YES
...
dth_cd_mail_gate() {
  ...
  dth_cd_log "CUSTOMER_TRAFFIC_MAIL_GATE=PASS mode=${LEADS_MAIL_MODE} allow_customer=${ALLOW_CUSTOMER_MAIL:-NO} allow_mock=${ALLOW_MOCK_MAIL_CUTOVER}"
}
